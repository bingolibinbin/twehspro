...
public class ExperiencesDTO {
	...
	public ExperiencesDTO(Integer contentid, Integer typeid, String typename,
	...
	public static ExperiencesDTO createDto(Content pojo) {
		ExperiencesDTO dto = null;
		if (pojo != null) {
			dto = new ExperiencesDTO(pojo.getContentid(), pojo.getTypeid(),
	...
	public static List createDtos(Collection pojos) {
		List<ExperiencesDTO> list = new ArrayList<ExperiencesDTO>();
		if (pojos != null) {
			Iterator iterator = pojos.iterator();
			while (iterator.hasNext()) {
				Content experiences = (Content) iterator.next();
				ExperiencesDTO dto = createDto(experiences);
				list.add(dto);
			}
		}
		return list;
